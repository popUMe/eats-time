			...
			<div class="css-jdmlr9">
				...
				<ul class="css-4hsfe0">
					...
					<li>배송관련, 주문(취소/교환/환불)관련 문의 및 요청사항은 마이컬리 내 <span
						class="highlight" href="/mypage/inquiry/list">1:1 문의</span>에
						남겨주세요.
					</li>
				</ul>
			</div>
...
<!-- 										</span></a> -->
								<div class="product-info-wrap">
									...
									<div class="product-subject-wrap">
										<p class="product-subject">섭취 기간</p>
									</div>
								</div>
							</div>
							<div class="column-create-at">23.04.15</div>
							<div class="column-comment-status">
								<span class="">답변대기</span>
							</div>
						</button>
						<div class="css-d3v9zr e14m4ys50"
		...
		<li class="css-dz42d5 e1mr9o7z1"><button class="css-r0xkg0 e1mr9o7z0">
				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="44"
...
$(document).ready(function(){
    ...
    $(".row-product").click(function(){
        var submenu = $(".inquiry-detail-content");
