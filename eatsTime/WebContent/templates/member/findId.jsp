...
<body>
		...
		<div class="css-u3y03b">
			<div class="css-1izr46f">
				<button type="button" class="css-1vhrqx7 certification-button">휴대폰
					인증</button>
				<button type="button" class="css-j8h1l4 certification-button">이메일
					인증</button>
			</div>
				...
				<div class="css-1blp8ou">
					...
					<div class="certification-number-wrap">
						<div class="css-5g3j4g">
							...
							<button class="css-m5a8v7 resend-button" type="button" width="88" height="48"
								radius="4">
	...
	<div id="modal2">
		<div class="banner-online">
			<div class="modal-content2">이메일 인증 화면으로 이동하시겠습니까? <br> 입력하신 휴대폰 인증 정보는 초기화됩니다.</div>
