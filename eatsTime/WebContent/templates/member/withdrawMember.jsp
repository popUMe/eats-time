	...
	<div class="css-luwwab">
		...
		<div class="css-833hqy">
			...
			<ul class="css-1x9bshx">
				<li><a class="active css-g4g0eu" id="li-3" onclick="history.back();">돌아가기 <svg
			...
			<a href="${pageContext.request.contextPath}listOk.inquiryboard" class="css-196gwz9 e19l01ug3">
					...
					<div class="css-1pjgd36 e744wfw6">
						...
						<div class="css-82a6rk e744wfw3">
							<div class="css-18n8lnw e9ted1s1">
								...
								<input type="hidden" id="memberBirthday" name="memberBirthday">
							</div>
						</div>
						<div class="css-1w0ksfz e744wfw2"></div>
					</div>
...
<script>
	...
	$("#modify").on("click", function(){
		...
		$("input[name='memberBirthday']").val($('#birthYear').val() + $('#birthMonth').val() + $('#birthDay').val());
