				...
				<li>
					<a href="">
						<div class="css-14yglsw e1cfowvj4">
							...
							<div class="css-b1hszl e1cfowvj2">작성자</div>
					...
					<a href="">
						<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;">
							<span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;">
								<img alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2780%27%20height=%27120%27/%3e" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;">
							</span>
							<img alt="샛별, 택배 배송 안내" srcset="https://res.kurly.com/main/banners/deliveryInfo.png 1x, https://res.kurly.com/main/banners/deliveryInfo.png 2x" src="https://res.kurly.com/main/banners/deliveryInfo.png" decoding="async" data-nimg="intrinsic" class="css-0" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%;">
						</span>						
					</a>
				</div>
				...
				<div class="css-1uaq400 e1tjwjt94">
					<button type="button" disabled class="css-1d3w5wq e1tjwjt90">
						<svg width="20" height="20" viewBox="0 0 18 18" fill="none" stroke="#ddd" xmlns="http://www.w3.org/2000/svg">
							<path d="M5 11L9 7L13 11" stroke="#ddd" stroke-width="1.3">
							</path>
						</svg>
					</button>
					"최근 본 상품"
					<div class="css-1f97cpw e1tjwjt93">
						<ul class="css-8erlkd e1tjwjt92">
							<li>
								<a href="" class="css-4obgpv e1tjwjt91">
									<span style="box-sizing: border-box; display: inline-block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: relative; max-width: 100%;">
										<span style="box-sizing: border-box; display: block; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; max-width: 100%;">
											<img alt="" aria-hidden="true" src="data:image/svg+xml,%3csvg%20xmlns=%27http://www.w3.org/2000/svg%27%20version=%271.1%27%20width=%2760%27%20height=%2780%27/%3e" style="display: block; max-width: 100%; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px;">
										</span>
										<img alt="recent-product-5052014" srcset="https://product-image.kurly.com/cdn-cgi/image/quality=85,width=120/product/image/a7b6d33e-0004-4fd4-a690-d1d9e0e13231.jpg 1x, https://product-image.kurly.com/cdn-cgi/image/quality=85,width=120/product/image/a7b6d33e-0004-4fd4-a690-d1d9e0e13231.jpg 2x" src="https://product-image.kurly.com/cdn-cgi/image/quality=85,width=120/product/image/a7b6d33e-0004-4fd4-a690-d1d9e0e13231.jpg" decoding="async" data-nimg="intrinsic" class="css-0" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: cover;">
									</span>
								</a>
							</li>
							<li>
								<a href="">
									...
									<img alt="recent-product-1000093836" srcset="https://product-image.kurly.com/cdn-cgi/image/quality=85,width=120/product/image/cc746bca-67d0-4783-acf2-91baf990180d.jpg 1x, https://product-image.kurly.com/cdn-cgi/image/quality=85,width=120/product/image/cc746bca-67d0-4783-acf2-91baf990180d.jpg 2x" src="https://product-image.kurly.com/cdn-cgi/image/quality=85,width=120/product/image/cc746bca-67d0-4783-acf2-91baf990180d.jpg" decoding="async" data-nimg="intrinsic" class="css-0" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: cover;">
									</span>
								</a>
							</li>
						</ul>
