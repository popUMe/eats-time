...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/css/member/memberProduct.css">
	...
	<div class="css-luwwab">
		<div class="css-833hqy">
			...
			<ul class="css-1x9bshx">
				<li><a class="active css-g4g0eu" id="li-1" href="${pageContext.request.contextPath}/productUploadList.product">상품 목록 <svg
				...
				<li><a class="css-g4g0eu" id="li-2" href="${pageContext.request.contextPath}/saleListOk.sale">판매 목록 <svg
							xmlns="http://www.w3.org/2000/svg" width="19" height="19"
							viewBox="0 0 24 24">
							<defs>
							<path id="gfk9q0rhta" d="M1.657 1.657L9.657 1.657 9.657 9.657"></path></defs>
			...
			<div class="css-j0lifa">
				<div class="css-fhxb3m">
					...
					<button type="button" class="css-a3vgo2"
						onclick="location.href='${pageContext.request.contextPath}/productUpload.product'">상품
						등록하기</button>
...
<script>
	let products = `${productUploadList}`;
