	...
	<div class="css-16c0d8l e1brqtzw0">
		<main id="product-atf" class="css-1eoy87d e17iylht4">
			...
			<section class="css-1ua1wyk e17iylht2">
				<div class="css-12lw2qc ezpe9l14">
					<c:out value="${productId.productCategory ? '배송' : '픽업'}" />
				</div>
				<div class="css-1fttcpj ezpe9l13">
					<div class="css-1bhm8h2 ezpe9l12">
						<h1 class="css-1f2zq3n ezpe9l11">
							<c:out value="${productId.productName}" />
						</h1>
					</div>
				...
				<h2 class="css-liviaq e1q8tigr5">
					<span class="css-9pf1ze e1q8tigr3"><c:out
							value="${productId.productPrice}" /></span> <span
						class="css-1x9cx9j e1q8tigr2">원</span>
				</h2>
				...
				<div class="css-iqoq9n e6qx2kx2">
					...
					<dl class="css-e6zlnr epzddad2">
						...
						<dd class="css-1k8t52o epzddad0">
							...
							<p class="css-uy94b2 e6qx2kx0">
								업체 별도 배송<br>(픽업제품의 경우 운영시간 별도 확인 요망)
							</p>
						</dd>
					</dl>
					...
					<dl class="css-e6zlnr epzddad2">
						<dt class="css-lytdfk epzddad1">
							<c:out value="${productId.memberIdentification}" />
						</dt>
						<dd class="css-1k8t52o epzddad0">
							<p class="css-c02hqi e6qx2kx1">
								<c:out value="${productId.memberName}" />
							</p>
						</dd>
					</dl>
					<!-- 유통기한 -->
					<dl class="css-e6zlnr epzddad2">
						...
						<dd class="css-1k8t52o epzddad0">
							<p class="css-c02hqi e6qx2kx1">
								<c:out
									value="${fn:split(productId.productExpirationDate, ' ')[0]}" />
							</p>
						</dd>
					</dl>
					...
					<dl class="css-e6zlnr epzddad2">
						...
						<dd class="css-1k8t52o epzddad0">
							<p class="css-c02hqi e6qx2kx1">
								<c:out value="${productId.productStock}" />
							</p>
						</dd>
					</dl>
					...
					<dl class="css-e6zlnr epzddad2">
						...
						<dd class="css-1k8t52o epzddad0">
							<p class="css-c02hqi e6qx2kx1">
								<c:out
									value="${productId.productAddress}
                        ${productId.productAddressDetail}" />
							</p>
						</dd>
					</dl>
				</div>
							...
							<dd class="css-1k8t52o epzddad0">
								<div class="cart-option-item css-1cb5lnc e1bjklo17">
									<div class="css-1qdyvok e1bjklo15">
										<span class="css-100vshh e1bjklo13"><c:out
												value="${productId.productName}" /></span>
									</div>
