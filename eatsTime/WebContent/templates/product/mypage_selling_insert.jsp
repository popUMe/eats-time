					...
					<div class="css-82a6rk">
						<div class="css-jmalg">
							<div class="css-detailwrite">
									<textarea placeholder="안내사항을 작성해주세요" class="productDetail">여러분 근손실은 못참죠!</textarea>
...
<!-- 									class="productDetail" value=""> -->
			...
			<div class="css-137ca2h">
				<button class="css-18m884r" type="submit" width="240" height="56"
					radius="3">
					<span class="css-ymwvow">수정완료</span>
				</button>
			</div>
		</div>
	</div>
