			...
			<div class="css-ixlb9s epvroj94">
				...
				<div class="css-bd9p1l e17a7yib9">
					...
					<span class="css-10nl60h e17a7yib7"><span
						class="css-9j7jhp e17a7yib6">[Kurly's] 데일리 물티슈(100매 X 10팩)</span></span>
					<!-- 상품 내용 부분 수량 -->
						...
						<div class="css-kc45zq e150alo82">
							...
							<div class="css-82a6rk e150alo80">
								<div class="css-lgy2fd e12ad82f1">
									...
									<div class="css-acvisw e1uzxhvi6">
										<label for="receiver-phone" class="css-c3g9of e1uzxhvi4">휴대폰</label><span
											class="css-19lkxd2 e1uzxhvi5">*</span>
										<div height="44" class="css-t7kbxx e1uzxhvi3">
											<input data-testid="input-box" id="receiver-phone"
												name="phone" placeholder="숫자만 입력해 주세요" type="tel"
									...
									<div style="padding-bottom: 25px;">
										...
										<div class="css-pfcyp7 egijpni0">
											<label class="css-z9g6s0 et8nqc33" for="door"><input
												...
												aria-labelledby="door" class="css-mgd87h et8nqc31">문
													앞</span></label><label class="css-z9g6s0 et8nqc33" for="security-office"><input
												data-testid="radio-SECURITY_OFFICE" id="security-office"
												name="receivePlace" type="radio"
												class="css-1pes2r6 et8nqc32" value="SECURITY_OFFICE"><span
												class="css-198i9ca e2sqze61"><div
														class="css-1dahn5m e2sqze60"></div></span><span
												aria-labelledby="security-office"
												class="css-mgd87h et8nqc31">경비실</span></label><label
												class="css-z9g6s0 et8nqc33" for="locker"><input
												data-testid="radio-PICKUP_BOX" id="locker"
												name="receivePlace" type="radio"
												class="css-1pes2r6 et8nqc32" value="PICKUP_BOX"><span
												class="css-198i9ca e2sqze61"><div
														class="css-1dahn5m e2sqze60"></div></span><span
									...
									<div class="css-acvisw e1uzxhvi6">
										<label for="receiver-name" class="css-c3g9of e1uzxhvi4">공동현관
											출입방법 </label><span class="css-19lkxd2 e1uzxhvi5">*</span>
										<div height="44" class="css-t7kbxx e1uzxhvi3">
											<input data-testid="input-box" id="receiver-name" name="name"
				...
				<div class="css-4c6dm7 epvroj93">
					<div class="css-134fy6p epvroj92">
								...
								<div class="css-gd125q e4nb37r1">
									...
									<div class="css-p04ye2 eqgsbpy1">
										...
										<div class="css-xok1if e1dfkh4o3">
											...
											<p class="css-5jw6s3 e1dfkh4o1">컬리카드, 최대 9만원 혜택 + 5% 추가
												적립</p>
											<p class="css-95xna2 e1dfkh4o0">첫 결제 즉시할인 3만원 + 최대 3만원
												쿠폰팩 + 3만원 적립금</p>
						...
						<ul class="css-wx42bm e4nb37r0">
							<li>※ 카카오페이, 토스, 네이버페이, 페이코 결제 시, 결제하신 수단으로만 환불되는 점
								양해부탁드립니다.</li>
		...
		<div class="MuiDialog-container MuiDialog-scrollPaper"
			...
			<div
				...
				<div
					...
					<button class="css-738xq4 e4nu7ef3 agreeCloseButton1" type="button" height="56"
						radius="0">
		...
		<div class="MuiDialog-container MuiDialog-scrollPaper"
			...
			<div
						...
						<div class="wrapper">
							...
							<div class="scroll_wrapper">
								<div class="terms_view">
									<strong class="tit_main">제1조 (목적)</strong> 본 약관은 주식회사 컬리페이(이하
				...
				<div
					...
					<button class="css-738xq4 e4nu7ef3 agreeCloseButton2" type="button" height="56"
						radius="0">
						<span class="css-ymwvow e4nu7ef1">확인</span>
					</button>
				</div>
