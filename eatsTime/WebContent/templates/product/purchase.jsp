...
<body>
   ...
   <div class="css-1ykiyus e146m4rf2">
      <form action="${contextPath}/purchasePayOk.purchase" method="post"
         id="payForm">
         <!-- 주문 전체 부분 -->
         <div class="css-1uom1od e146m4rf0">
            ...
            <div class="css-ixlb9s epvroj94">
               ...
               <div class="css-bd9p1l e17a7yib9">
                  <img
                     src="${pageContext.request.contextPath}/upload/${product.fileName}"
                     alt="" class="css-1ixzt3f e17a7yib8">
                  <!-- 상품 내용 부분 내용 -->
                  <span class="css-10nl60h e17a7yib7"><span
                     class="css-9j7jhp e17a7yib6"><c:out
                           value="${product.productName}" /></span></span>
                  <!-- 상품 내용 부분 유통기한 -->
                  <span class="css-1efb5i1 e17a7yib4">유통기한<br> <c:out
                        value="${fn:split(product.productExpirationDate, ' ')[0]}" /></span>
                  <!-- 상품 내용 부분 수량 -->
                  <span class="css-1efb5i1 e17a7yib4"><c:out
                        value="${count}개" /></span>
                  <!-- 상품 내용 부분 가겨 -->
               ...
               <div id="kurly-orderer-info" class="css-shoa2s e1vfdada3">
                  ...
                  <div class="css-yazyg9 e150alo82">
                     ...
                     <div class="css-82a6rk e150alo80">
                        <div class="css-t6o2y8 e1vfdada2">
                  ...
                  <div class="css-yazyg9 e150alo82">
                     ...
                     <div class="css-82a6rk e150alo80">
                        <c:out value="${member.memberEmail}" />
                        <div class="css-1r0yqr6 e1vfdada1"></div>
                     </div>
                  </div>
               </div>
               <!-- 배송 정보 부분 전체 -->
               ...
               <div class="css-iqoq9n e1pxan880">
                  ...
                  <!-- 배송주소 부분 -->
                  <c:choose>
                     <c:when test="${product.productCategory}">
                                       ...
                                       <div style="display: flex; justify-content: space-between">
                                          ...
                                          <div class="css-iqoq9n e1pxan880">
                                             <button class="css-q8bpgr e4nu7ef3" id="address_kakao"
                                                name="address_kakao" type="button" width="60"
                                                height="30" radius="3">
                     ...
                     <c:otherwise>
                        <div id="checkout-shipping-details"
                           class="css-1y0xj4c e1pxan881 addressPickup" style="">
                           <div class="css-1gshg9u e150alo82">
                              ...
                              <div class="css-82a6rk e150alo80">
                                 <div class="css-lgy2fd e12ad82f1"
                                    ...
                                    <div class="css-acvisw e1uzxhvi6"
                                       ...
                                       <br>
                                       <div height="44" class="css-t7kbxx e1uzxhvi3">
                                          <input data-testid="input-box" id="pickupAddress"
                                             name="purAddress" placeholder="" type="text" required=""
                                             height="44" class="css-1quw3ub e1uzxhvi2"
                                             value="${product.productAddress}" readonly>
                                       </div>
                                       <br>
                                       <div height="44" class="css-t7kbxx e1uzxhvi3">
                                          <input data-testid="input-box" id=pickupAddressDetail
                                             " name="purAddressDetail" placeholder="" type="text"
                                             required="" height="44" class="css-1quw3ub e1uzxhvi2"
                                             value="${product.productAddressDetail}" readonly>
                                       </div>
                                       <br>
                                    </div>
                                 </div>
                     ...
                     <c:otherwise>
                        <div class="css-yazyg9 e150alo82">
                           ...
                           <div class="css-82a6rk e150alo80">
                              ...
                              <div class="css-t6o2y8 e1vfdada2">0원</div>
                           </div>
                        </div>
                     </c:otherwise>
                           ...
                           <div class="css-acvisw e1uzxhvi6">
                              ...
                              <div height="44" class="css-t7kbxx e1uzxhvi3">
                                 <input data-testid="input-box" id="receiver-input1"
                                    name="purName" placeholder="이름을 입력해 주세요" type="text"
                                    required="" height="44" class="css-1quw3ub e1uzxhvi2"
                                    value="">
                           ...
                           <div class="css-acvisw e1uzxhvi6">
                              ...
                              <div height="44" class="css-t7kbxx e1uzxhvi3">
                                 <input data-testid="input-box" id="receiver-input2"
                                    name="purPhoneNumber" placeholder="숫자만 입력해 주세요" type="tel"
                                    required="" height="44" class="css-1quw3ub e1uzxhvi2"
                                    value="">
                                 <button class="css-118q5z4 e8bjkbi0" size="16"
                                    id="delete-input" tabindex="-1" aria-label="delete-input"
                           ...
                           <div class="css-acvisw e1uzxhvi6">
                              ...
                              <div height="44" class="css-t7kbxx e1uzxhvi3">
                                 <input data-testid="input-box" id="receiver-input3"
                                    name="purLocation" placeholder="ex)문앞, 경비실, 택배함, 기타장소"
                                    type="text" required="" height="44"
                           ...
                           <div class="css-acvisw e1uzxhvi6">
                              ...
                              <div height="44" class="css-t7kbxx e1uzxhvi3">
                                 <input data-testid="input-box" id="receiver-input4"
                                    name="purPw"
                                    placeholder="ex)공동현관 비밀번호는 1234 입니다, 자유 출입 가능합니다"
                                    type="text" required="" height="44"
                                    class="css-1quw3ub e1uzxhvi2" value="">
                                 <button class="css-118q5z4 e8bjkbi0" size="16"
                                    id="delete-input" tabindex="-1" aria-label="delete-input"
            ...
            <div class="css-4c6dm7 epvroj93">
                  ...
                  <c:choose>
                     <c:when test="${product.productCategory}">
                        <div class="css-1azakc el0c5j40">
                           <button class="css-1lha8en e4nu7ef3 payButton" type="button"
                              width="240" height="56" radius="3">
                              <span class="css-ymwvow e4nu7ef1"><c:out
                                    value="${product.productPrice*count + 3000}" />원 결제하기</span>
                           </button>
                        </div>
                     </c:when>
                     <c:otherwise>
                        <div class="css-1azakc el0c5j40">
                           <button class="css-1lha8en e4nu7ef3 payButton" type="button"
                              width="240" height="56" radius="3">
                              <span class="css-ymwvow e4nu7ef1"><c:out
                                    value="${product.productPrice*count}" />원 결제하기</span>
                           </button>
                        </div>
                     </c:otherwise>
                  </c:choose>
               ...
               <c:choose>
                  <c:when test="${product.productCategory}">
                     <input type="hidden" name="purTotalPrice"
                        value="${product.productPrice*count + 3000}">
                  </c:when>
                  <c:otherwise>
                     <input type="hidden" name="purTotalPrice"
                        value="${product.productPrice*count}">
                  </c:otherwise>
               </c:choose>
               <!-- 여기 아이디에 세션 대신  -->
                           ...
                           <div class="css-11quaim eahaaoi10">
                              ...
                              <div>
                                 <span class="css-2pg1ps eahaaoi8"><span
                                    class="css-rfpchb eahaaoi1"></span> <c:out
                                       value="${product.productPrice*count}" /></span><span
                              ...
                              <c:when test="${product.productCategory}">
                                 ...
                                 <div class="css-gs4y0w eahaaoi5">
                                    ...
                                    <div>
                                       <span class="css-2pg1ps eahaaoi8"><span
                                          class="css-rfpchb eahaaoi1"></span> <c:out
                                             value="${product.productPrice*count + 3000}" /></span><span
                                          class="css-vu318a eahaaoi6">원</span>
                                    </div>
                                 </div>
                              </c:when>
...
<script>
   ...
   let memberId = JSON.parse(`${memberId}`);
   let count = `${count}`;
</script>
<script src="${pageContext.request.contextPath}/static/js/bootPay.js"></script>
<script
