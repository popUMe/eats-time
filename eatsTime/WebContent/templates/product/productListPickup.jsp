...
<body>
   ...
   <div class="css-emt8cc e12kjs5e0">
      <div id="container" class="css-1i60c0e e13nsthd2">
         ...
         <!-- [S] title -->
         <h3 class="css-i804ml eaf14xt0">픽업 제품보기</h3>
         <!-- [E] title -->
            ...
            <div class="css-1d3w5wq ef36txc6">
               ...
               <div class="wrap-filter">
                  <div class="css-1stur9s eudxpx34">
                     ...
                     <ul class="css-1vmfy7j eudxpx32">
                        ...
                        <!-- 최신순 -->
                        <li class="css-5uzvtq eudxpx31 firstLi pickUpOrder"><a
                           class="${sort == null or sort == 'recent' ? 'css-126imjl' : ''} css-19ce13b eudxpx30">최신순</a>
                        </li>

                        <!-- 낮은 가격순 -->
                        <li class="css-5uzvtq eudxpx31 pickUpOrder"><a
               ...
               <div class="css-rdz8z7 e82lnfz1">
                  ...
                  <a class="css-1d20dg7 e82lnfz0"
                     href="${pageContext.request.contextPath}/productListPickUpOk.product?page=1&sort=${sort}">
                     <img
                  ...
                  <c:if test="${prev}">
                     <a class="css-1d20dg7 e82lnfz0"
                        href="${pageContext.request.contextPath}/productListPickUpOk.product?page=${startPage - 1}&sort=${sort}">
                        <img
                  ...
                  <c:forEach var="i" begin="${startPage}" end="${endPage}">
                     <c:choose>
                        ...
                        <c:otherwise>
                           <a
                              href="${pageContext.request.contextPath}/productListPickUpOk.product?page=${i}&sort=${sort}"
                  ...
                  <c:if test="${next}">
                     <a class="css-1d20dg7 e82lnfz0"
                        href="${pageContext.request.contextPath}/productListPickUpOk.product?page=${endPage + 1}&sort=${sort}">
                        <img
                  ...
                  <!-- 마지막 페이지로 이동하기 -->
                  <a class="css-1d20dg7 e82lnfz0"
                     href="${pageContext.request.contextPath}/productListPickUpOk.product?page=${realEndPage}&sort=${sort}">
                     <img
