				...
				<div class="css-1d3w5wq ef36txc6">
					...
					<div class="css-1stur9s eudxpx34">
						...
						<ul class="css-1vmfy7j eudxpx32">
							...
							<!-- 낮은 가격순 -->
							<li class="css-5uzvtq eudxpx31">
								<a href="#" class="css-126imjl eudxpx30">낮은 가격순</a>
							</li>
							
							<!-- 높은 가격순 -->
							<li class="css-5uzvtq eudxpx31">
								<a href="#" class="css-126imjl eudxpx30">높은 가격순</a>
							</li>
						</ul>
					</div>
					<!-- [E] 제품 개수/필터 선택 -->
						...
						<div class="css-11kh0cw ef36txc5">
							...
							<a href="#" class="css-1xyd46f e1c07x4814">
								...
								<div class="css-0 e1c07x4812">
									<div class="e1c07x4813 css-1kth2sq e3um3060">
										<span style="box-sizing: border-box; display: block; overflow: hidden; width: initial; height: initial; background: none; opacity: 1; border: 0px; margin: 0px; padding: 0px; position: absolute; inset: 0px;">
											<img alt="상품 이미지" src="https://img-cf.kurly.com/cdn-cgi/image/quality=85,width=676/shop/data/goods/165304027922l0.jpg" decoding="async" data-nimg="fill" class="css-0" sizes="100vw" style="position: absolute; inset: 0px; box-sizing: border-box; padding: 0px; border: none; margin: auto; display: block; width: 0px; height: 0px; min-width: 100%; max-width: 100%; min-height: 100%; max-height: 100%; object-fit: cover;">
										</span>
										<div>
								...
								<div class="css-c1cgl e1c07x489">
									...
									<div class="css-1hrnl0u e1cvv2hm1">…</div>flex
								</div>
							</a>
