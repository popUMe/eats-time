...
<body>
	<!-- 푸터 전체 -->
	<div class="css-odadb1 ebj6vxr6">

		<div id="footer" class="css-1i60c0e ebj6vxr5">
			<!-- 푸터 윗부분 -->
			<div class="css-j6zuv6 ebj6vxr4">
				<!-- 푸터 고객행복센터 부분 -->
				<div class="css-0 eam2qm510">
					<h2 class="css-4iyald eam2qm59">고객행복센터</h2>
					<strong class="css-9jqcug eam2qm57">1234-5678<span
						class="css-1uz1ro8 eam2qm58">월~토요일 오전 9시 - 오후 6시</span></strong>
					<div class="css-1fttcpj eam2qm56">
...
<!-- 						<div class="css-ho1qnd eam2qm53" style="visibility: hidden">
							<button class="css-1pgo3vb eam2qm55">삭제 예정</button>
							<div class="css-1lxmeik eam2qm52">
								월~금요일
								<svg width="1" height="10" viewBox="0 0 1 10" fill="none"
									xmlns="http://www.w3.org/2000/svg" class="css-w0fx7a eam2qm50">
					...
					<div class="css-vtjvf eam2qm51">
						비회원 문의 : <a href="mailto:help@kurlycorp.com">injin0318@gmail.com</a><!-- <br>비회원 -->
						<!-- 대량주문 문의 : <a href="mailto:kurlygift@kurlycorp.com">injin0318@gmail.com</a> -->
					</div>
				</div>
				<!-- 푸터 컬리소개 컬리소개영상 투자정보 .. 부분 -->
				<div class="css-1fttcpj ebj6vxr3">
					<ul class="css-17hse91 e13nap1l2" style="visibility: hidden">
						<li class="css-1tayzmu e13nap1l1"><a href="/introduce"
							target="_self" class="css-1tfhwyj e13nap1l0">컬리소개</a></li>
						<li class="css-1tayzmu e13nap1l1"><a
						...
						<li class="css-1tayzmu e13nap1l1"><a href="/user-guide"
							target="_self" class="css-1tfhwyj e13nap1l0">이용안내</a></li>
					</ul>
					<div class="css-bz7mfs ebj6vxr2">
						법인명 (상호) : 주식회사 이츠타임 <span class="css-1ekjygq ebj6vxr1"></span>
						...
						<!-- <a
							...
							확인</a> -->
						<br>통신판매업 : 제 2022-서울강남-12345 호 <span
							class="css-1ekjygq ebj6vxr1"></span> 개인정보보호책임자 : 이종문<br>주소 :
						서울특별시 강남구 테헤란로 26길 12, 13층(역삼동) <span class="css-1ekjygq ebj6vxr1"></span>
						대표이사 : 박유미<br><!-- 입점문의 :<a
							href="https://docs.google.com/forms/d/e/1FAIpQLScLB7YkGJwNRzpGpp0gbR1i4C1_uvTEFj43SFfJ_XEadTn3gQ/viewform?usp=sf_link"
							target="_blank" rel="noreferrer" class="css-1tby8gd ebj6vxr0">입점문의하기</a><span
							class="css-1ekjygq ebj6vxr1"></span>제휴문의 :<a
							href="mailto:business@kurlycorp.com" class="css-1tby8gd ebj6vxr0">business@kurlycorp.com</a><br>채용문의
						:<a href="mailto:recruit@kurlycorp.com"
							class="css-1tby8gd ebj6vxr0">recruit@kurlycorp.com</a><br> -->팩스:
						012 - 3456 - 7899
					</div>
			...
			<div class="css-81eeg3 e1t23cq0">
				<button class="css-12t5wjq e57xuci2">
					...
					<p class="css-bft4sh e57xuci0">
						[인증범위] 이츠타임 서비스 개발·운영<br>(심사받지 않은 물리적 인프라 제외)<br>[유효기간]
						2022.01.19 ~ 2025.01.18
					</p>
				</button>
				<button class="css-12t5wjq e57xuci2">
					<img src="https://res.kurly.com/pc/ico/2208/logo_privacy.svg"
						alt="eprivacy plus 로고" class="css-1262i6n e57xuci1">
					<p class="css-bft4sh e57xuci0">
				...
				<button class="css-12t5wjq e57xuci2">
					<img src="https://res.kurly.com/pc/ico/2208/logo_tosspayments.svg"
						alt="payments 로고" class="css-as7ifw e57xuci1">
					<p class="css-bft4sh e57xuci0">
				...
				<button class="css-12t5wjq e57xuci2">
					<img src="https://res.kurly.com/pc/ico/2208/logo_wooriBank.svg"
						alt="우리은행 로고" class="css-1262i6n e57xuci1">
					<p class="css-bft4sh e57xuci0">
		...
		<div class="css-175n8cp etk3uz81">
			이츠타임에서 판매되는 상품 중에는 이츠타임에 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.<br>마켓플레이스(오픈마켓)
			상품의 경우 이츠타임은 통신판매중개자로서 통신판매의 당사자가 아닙니다. 이츠타임은 해당 상품의 주문, 품질, 교환/환불 등 의무와
			책임을 부담하지 않습니다. <em class="css-1vhhy2d etk3uz80">© EATSTIME CORP.
