...
<body>
	...
	<div class="css-odadb1 ebj6vxr6">
		...
		<div id="footer" class="css-1i60c0e ebj6vxr5">
			...
			<div class="css-j6zuv6 ebj6vxr4">
				...
				<div class="css-0 eam2qm510">
					...
					<strong class="css-9jqcug eam2qm57">1644-1107<span
						class="css-1uz1ro8 eam2qm58">월~토요일 오전 7시 - 오후 6시</span></strong>
					<div class="css-1fttcpj eam2qm56">
						...
						<div class="css-ho1qnd eam2qm53">
							<button class="css-1pgo3vb eam2qm55">1:1 문의</button>
							<div class="css-1lxmeik eam2qm52">
					...
					<div class="css-vtjvf eam2qm51">
						비회원 문의 : <a href="mailto:help@kurlycorp.com">help@kurlycorp.com</a><br>비회원
						대량주문 문의 : <a href="mailto:kurlygift@kurlycorp.com">kurlygift@kurlycorp.com</a>
					</div>
				</div>
				...
				<div class="css-1fttcpj ebj6vxr3">
					...
					<div class="css-bz7mfs ebj6vxr2">
						법인명 (상호) : 주식회사 컬리 <span class="css-1ekjygq ebj6vxr1"></span>
						사업자등록번호 : 261-81-23567<a
							...
							확인</a><br>통신판매업 : 제 2018-서울강남-01646 호 <span
							class="css-1ekjygq ebj6vxr1"></span> 개인정보보호책임자 : 이원준<br>주소 :
						서울특별시 강남구 테헤란로 133, 18층(역삼동) <span class="css-1ekjygq ebj6vxr1"></span>
						대표이사 : 김슬아<br>입점문의 :<a
		...
		<div class="css-175n8cp etk3uz81">
			컬리에서 판매되는 상품 중에는 컬리에 입점한 개별 판매자가 판매하는 마켓플레이스(오픈마켓) 상품이 포함되어 있습니다.<br>마켓플레이스(오픈마켓)
			상품의 경우 컬리는 통신판매중개자로서 통신판매의 당사자가 아닙니다. 컬리는 해당 상품의 주문, 품질, 교환/환불 등 의무와
			책임을 부담하지 않습니다.<em class="css-1vhhy2d etk3uz80">© KURLY CORP. ALL
				RIGHTS RESERVED</em>
		</div>
	</div>
</body>
