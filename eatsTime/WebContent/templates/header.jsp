	...
	<div>
		...
		<div class="css-t79vuj e15sbxqa2">
			...
			<div class="css-fexq9b eo7pjfk4">
				<a class="css-1g7d8zf eo7pjfk2">회원가입</a>
				<div class="css-1qgm48u eo7pjfk0"></div>
				<a class="css-1pu21l0 eo7pjfk2">로그인</a>
				<div class="css-1qgm48u eo7pjfk0"></div>
				<div class="css-1qolcqm eo7pjfk3" id="board">
					<a class="css-1pu21l0 eo7pjfk2">고객센터<span
			...
			<div class="css-r7wmjj e15sbxqa3">
				...
				<div class="css-boc80u ekdqe1a2">
					...
					<button class=" css-1sia941 ekdqe1a0">삭제예정</button>
				</div>
				<!-- 검색창 부분 -->
			...
			<div class="css-mlddcv e17w4cfr6">
				...
				<ul class="css-1887xqd e17w4cfr5">
					<li class="css-59mmhh e17w4cfr4"><span
						class="css-1xyu7j9 e17w4cfr2">배송&픽업</span></li>
					<li class="css-59mmhh e17w4cfr4"><span
						class="css-1xyu7j9 e17w4cfr2">배송</span></li>
					<li class="css-59mmhh e17w4cfr4"><span
						class="css-1xyu7j9 e17w4cfr2">픽업</span></li>
					<li class="css-59mmhh e17w4cfr4"><span
						class="css-1xyu7j9 e17w4cfr2">삭제예정</span></li>
				</ul>
				<!-- 헤더 샛별, 택배 배송안내 부분 -->
