	...
	<div class="css-1yyw8xd e1ojcw7k1">
		...
		<div class="css-bjn8wh e1ojcw7k0">
			...
			<div class="css-1b87835 e1seig3y0">
					...
					<div class="css-lj9hak e1dkubq62">
						...
						<div
							...
							<section class="container">
								...
								<button type="button" direction="left"
									class="css-1lsz3kj e9otvnb0"></button>
								<button type="button" direction="right"
									class="css-kfz8up e9otvnb0"></button>
				...
				<!-- 이상품어때요? -->
				<div style="text-align: center">여기 부분부터는 유미가 작업한 상품 부분 가져와서 들어갈 예정</div>
			</div>
		</div>
	</div>
