...
public class ProductListPickUpOkController implements Action {
   ...
   public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
      ...
      Criteria criteria = new Criteria(page, productDAO.getPickUpTotal(), sort, "pickUp");
      ...
      criteria = new Criteria(page, productDAO.getPickUpTotal(), sort, "pickUp");
      
      productDAO.selectPickUpAll(pagable).stream().map(product -> new JSONObject(product)).forEach(jsonArray::put);
      
      
      req.setAttribute("realEndPage", criteria.getRealEndPage());
      req.setAttribute("product", jsonArray.toString());
      req.setAttribute("total", productDAO.getPickUpTotal());
